...
VeSwapChain::VeSwapChain(VeDevice &deviceRef, VkExtent2D extent, std::shared_ptr<VeSwapChain> previous) : device{deviceRef}, windowExtent{extent}, oldSwapChain{previous} {
	init();
