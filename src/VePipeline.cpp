...
void	VePipeline::createGraphicsPipeline(
	...
	assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphics pipelines");
	assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create graphics pipelines");
